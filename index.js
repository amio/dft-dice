window.onload = function () {
  ...
  var attendees = {
    ...
    '前段分享': ['陈海舟', '陈捷', '陈名', '陈斯召', '陈威', '陈歆丽', '陈宇', '陈子田', '程斯亮', '邓勇元', '丁美华', '范虎', '范青轩', '范志能', '高林植', '黄龙', '黄茹艺', '纪铜雪', '姜天意', '金加斌', '李鸿超', '李江博', '李敏军', '梁雯琦', '廖伟华', '廖证', '林建锋', '林锐', '林小米', '刘龙龙', '卢成举', '吕明', '麻幸林', '茅晓锋', '缪晓栋', '牛延辉', '秦彬阳', '秦玉国', '邵敏', '沈立俊', '苏芯', '孙向军', '唐松松', '王佳人', '王建', '王鑫亮', '王卓', '吴梦圆', '谢小华', '徐飞', '徐婉芳', '徐钊雄', '许成', '薛梦飞', '杨金龙', '杨胜', '杨炜健', '杨武', '尹正波', '喻浩', '袁坤', '袁源', '袁源', '翟羽', '张驰', '张峰华', '张君君', '张婉娇', '张杨明', '赵芝晴', '郑刚', '朱海源', '祝君', '邹瑞'],
...
function Prizes(prizes) {
  ...
  this.setPrize = function (prize, names) {
    window.dice.names = names;
  }
